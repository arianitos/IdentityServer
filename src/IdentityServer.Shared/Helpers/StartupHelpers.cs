...
using SendGrid;
using IdentityServer.Shared.Configuration.Common;
using IdentityServer.Shared.Configuration.Email;
using IdentityServer.Shared.Email;

namespace IdentityServer.Shared.Helpers
{
